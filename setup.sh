...
# \033[1;92m'
if grep -q '# 011' '~/home/termuxstyling/ver.cfg'
then
	ln=\$( sed '2q;d' '~/home/termuxstyling/ver.cfg' )
	ln=\$( echo \$ln | sed 's/# 011//g' )
	ln=\$( echo \$ln | sed 's/ //g' )
		if [ \$ln -neq 10 ]
		then
			ln=\$ln+1
			sed -i \"/.*# 011.*/ c\\\$ln # 011\" \"~/home/termuxstyling/ver.cfg\"
		else
			ln=1
			sed -i \"/.*# 011.*/ c\\\$ln # 011\" \"~/home/termuxstyling/ver.cfg\"
			updatedw
		...
		echo \"1 # 011\" > \"~/home/termuxstyling/ver.cfg\"
	fi
cd
alias md=\"mkdir\"
